...
const CategoryPage = () => {
  ...
  return (
    <div className="mb-5 px-5">
      <h1 className="font-semibold text-center py-3 mb-2">Categories</h1>
          ...
          <div key={category.id} className="flex items-center gap-5">
            <div>
              <img
                ...
                className="w-48 h-32 xl:60 rounded-lg"
              />
              {onEdit === category.id ? (
                <Input
                  className="mt-3 w-48"
                ...
                {onEdit === category.id && (
                  <div className="flex items-center justify-between w-full">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="w-10 bg-transparent text-red-700 hover:text-white hover:bg-red-900"
                    >
